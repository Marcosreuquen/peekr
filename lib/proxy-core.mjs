...
export function createProxyServer(opts = {}) {
  ...
  const server = http.createServer((req, res) => {
    ...
    req.on('end', () => {
      ...
      // Strip peekr-internal headers before forwarding upstream
      const forwardHeaders = { ...req.headers, host: upstreamHost };
      delete forwardHeaders['x-peekr-dest'];
      delete forwardHeaders['x-peekr-dest-port'];
      delete forwardHeaders['x-peekr-dest-proto'];
